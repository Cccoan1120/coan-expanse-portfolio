...
export const projects: Project[] = [
  {
    ...
    logo: { src: "/images/project-logos/mine.webp", alt: "Mine" },
    showcaseRank: 1,
    featuredRank: 1,
    privacy: "公开",
    tagline: "把收藏的内容整理成可检索、可追问的素材，再生成创作草稿。",
    summary:
  ...
  },
  {
    ...
    status: "live",
    domains: ["ai-product"],
    logo: { src: "/images/project-logos/orbito.webp", alt: "Orbito" },
    showcaseRank: 2,
    featuredRank: 2,
    privacy: "公开",
    tagline: "把每天的任务、习惯和生活记录放在一起，支持离线使用和可选的私有云同步。",
    summary:
  ...
  },
  {
    ...
    status: "maintaining",
    domains: ["ai-product", "automation-tools"],
    logo: { src: "/images/project-logos/offer-atlas.webp", alt: "Offer Atlas" },
    showcaseRank: 3,
    spotlightRank: 1,
    privacy: "公开",
    tagline: "把刷题、定期复习和面试复盘放在同一个工作台，保留答案版本与经确认的经历事实。",
    summary:
  ...
  },
  {
    ...
    logo: { src: "/images/project-logos/music-market-radar.webp", alt: "Music Market Radar" },
    showcaseRank: 4,
    spotlightRank: 2,
    privacy: "公开",
    tagline: "对照网易云、QQ 音乐与 YouTube 的音乐趋势，分别呈现榜单相对热度和官方公开视频统计。",
    summary:
  ...
  },
  {
    ...
    logo: { src: "/images/project-logos/kol-review-desk-transparent.webp", alt: "KOL Review Desk" },
    showcaseRank: 6,
    featuredRank: 3,
    privacy: "已脱敏",
    tagline: "汇总海外达人资料与邮件，用 AI 起草回复。发送和飞书写入由运营人员确认。",
    summary:
  ...
  },
  {
    ...
    logo: { src: "/images/project-logos/teeni-insight-suite.webp", alt: "Teeni 对话分析套件" },
    showcaseRank: 7,
    featuredRank: 4,
    privacy: "已脱敏",
    tagline: "分析儿童对话质量，支持异常复核、报告导出和重新运行，儿童安全始终单独把关。",
    summary:
  ...
  },
  {
    ...
    status: "live",
    domains: ["ai-product", "automation-tools"],
    logo: { src: "/images/project-logos/offerexpert.webp", alt: "OfferExpert" },
    showcaseRank: 9,
    privacy: "公开",
    tagline: "从获准使用的访谈和播客中整理面试经验，再结合经确认的简历与岗位信息准备回答。",
